...
from apps.home.views import credentials, pinata_service, students
...
urlpatterns = [
    ...
    path('createstudent', students.students_management, name='create_students'),
    # @todo: mandar funciones para CRUD
